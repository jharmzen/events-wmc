...
export default function HeroDesktop() {
  return (
    <div
      ...
      style={{ backgroundImage: 'url("/images/jhb-masterclass-20260919/hero-bg.png")', backgroundSize: 'cover', backgroundPosition: 'center right', position: 'relative' }}
    >
      <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, rgba(255,255,255,1) 0%, rgba(255,255,255,0.97) 38%, rgba(255,255,255,0.6) 58%, rgba(255,255,255,0) 78%)', zIndex: 0, pointerEvents: 'none' }} />
        ...
        <div className="elementor-element elementor-element-4246301f e-con-full e-flex e-con e-child" data-id="4246301f" data-element_type="container" data-settings='{"background_background":"classic"}' style={{ marginTop: 0 }}>
          <div className="elementor-element elementor-element-6608053b elementor-widget elementor-widget-image" data-id="6608053b" data-element_type="widget" data-widget_type="image.default">
            <img
              ...
              width="600"
              height="156"
              src="/images/wmc-logo-trans-navy-600x156.png"
              className="attachment-medium size-medium wp-image-1237"
              alt="Wealth Masters Club"
              srcSet="/images/wmc-logo-trans-navy-300x78.png 300w, /images/wmc-logo-trans-navy-600x156.png 600w"
          ...
          <div className="elementor-element elementor-element-8b3c19f2 elementor-widget elementor-widget-text-editor" data-id="8b3c19f2" data-element_type="widget" data-widget_type="text-editor.default">
            <p style={{ fontSize: '12px', fontWeight: 700, margin: '8px 0 0' }}>
