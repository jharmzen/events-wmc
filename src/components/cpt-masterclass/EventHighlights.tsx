...
// TODO: Replace with CPT-specific event highlight images when available
const highlightImages = [
  { src: '/images/jhb-04072026-highlight-1.png', alt: 'Wealth Masters Club masterclass — Lord Charles Hotel, Somerset West' },
  { src: '/images/jhb-04072026-highlight-2.png', alt: 'Wealth Masters Club masterclass — Lord Charles Hotel, Somerset West' },
  { src: '/images/jhb-04072026-highlight-3.png', alt: 'Wealth Masters Club masterclass — Lord Charles Hotel, Somerset West' },
  { src: '/images/jhb-04072026-highlight-4.png', alt: 'Wealth Masters Club masterclass — Lord Charles Hotel, Somerset West' },
  { src: '/images/jhb-04072026-highlight-5.png', alt: 'Wealth Masters Club masterclass — Lord Charles Hotel, Somerset West' },
  { src: '/images/jhb-04072026-highlight-6.png', alt: 'Wealth Masters Club masterclass — Lord Charles Hotel, Somerset West' },
  { src: '/images/jhb-04072026-highlight-7.png', alt: 'Wealth Masters Club masterclass — Lord Charles Hotel, Somerset West' },
]
    ...
    <>
      ...
      >
        <div className="e-con-inner">
          ...
          <div className="elementor-element elementor-element-546cb59c elementor-widget-mobile__width-initial elementor-widget elementor-widget-text-editor" data-id="546cb59c" data-element_type="widget" data-widget_type="text-editor.default" style={{ lineHeight: 1.4 }}>
            <p>Our masterclasses are designed to be practical, engaging and strategy-focused giving you the insights, clarity and direction to take your next property move with confidence.</p>
          </div>
        </div>
      </div>
      <div
