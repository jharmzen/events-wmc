export default function SellsOutBanner() {
  return (
    <div
      className="elementor-element elementor-element-502faf4f e-flex e-con-boxed e-con e-parent"
      data-id="502faf4f"
    ...
    >
      <div className="e-con-inner">
        <div className="elementor-element elementor-element-7bd013c elementor-widget__width-inherit elementor-widget-mobile__width-inherit elementor-widget elementor-widget-text-editor" data-id="7bd013c" data-element_type="widget" data-widget_type="text-editor.default">
          <p>Attendance is limited and demand is often high.<br />We recommend securing your seat as early as possible.</p>
        </div>
      </div>
    </div>
  )
