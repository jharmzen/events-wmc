const cities = [
  {
    ...
    img: '/images/city-card-capetown.png',
    pageLink: 'https://events.wealthmastersclub.com/cpt-masterclass-20260725',
  ...
  },
  {
    ...
    pageLink: 'https://events.wealthmastersclub.com/jhb-masterclass-20260815',
