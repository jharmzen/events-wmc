      ...
      <div className="e-con-inner" style={{ alignItems: 'stretch' }}>
        ...
        >
          ...
          >
            ...
            >
              <h2 className="elementor-heading-title elementor-size-default">One Property Decision Can Shape Your Next 10 Years</h2>
            </div>
            <div
            ...
            >
              ...
              <p><strong>R800 per person | R1,200 for 2 people | R1,600 for 3 people<br />Platinum Members Attend Free</strong></p>
            </div>
            <div
